...
<body>
  ...
  <div class="search" id="salles">
    <h1>Réservez l’espace idéal pour vos réunions et événements professionnels.</h1>
  ...
  <div class="articles-container">
    <div class="sub-recommendations">
      <h4>Les meilleurs salles de reunion de monde</h4>
      <p>Trouvez l'espace idéal pour vos réunions et événements professionnels.</p>
      <div class="recomm-options">
        <?php
          $req = "SELECT * FROM establishments WHERE type = 'salle' ORDER BY stars desc, price desc LIMIT 6";
          $res = $cnx->query($req);
          if($res->rowCount() > 0){
            foreach($res as $row){
        ?>
        <div class="article1" id="art">
          ...
          <div class="article-info">
            ...
            <button data-bs-toggle="modal" data-bs-target="#<?php echo $row['id_establishment']; ?>">Reserver</button>            </div>
          </div>
        </div>
  ...
  <div class="infos-rapide">
    ...
    <div class="infos-container">
      <div class="infos">
        ...
        <h6>Des Salles de Reunion dans tout le monde</h6>
        <h6>10 000+</h6>
      </div>
      <div class="infos">
        <i class="fa-solid fa-location-dot"></i>
        <h6>Des Salles de Reunion dans la Tunisie</h6>
        <h6>400+</h6>
      </div>
      <div class="infos">
