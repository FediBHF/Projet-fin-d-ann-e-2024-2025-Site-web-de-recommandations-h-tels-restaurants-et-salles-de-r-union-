...
<head>
  ...
  <title>RoamMate - Restaurants</title>
</head>
<body>
  ...
  <div class="search" id="restaurants">
    <h1>Trouvez le restaurant parfait pour une expérience culinaire inoubliable</h1>
  ...
  <div class="articles-container">
    <div class="sub-recommendations">
      <h4>Les meilleurs restaurants de monde</h4>
      <p>Découvrez les meilleurs restaurants.</p>
      <div class="recomm-options">
        <?php
          $req = "SELECT * FROM establishments WHERE type = 'restaurant' ORDER BY stars desc, price desc LIMIT 6";
          $res = $cnx->query($req);
          if($res->rowCount() > 0){
            foreach($res as $row){
        ?>
  ...
  <div class="infos-rapide">
    ...
    <div class="infos-container">
      <div class="infos">
        ...
        <h6>Des Restaurants dans tout le monde</h6>
        <h6>23+ million</h6>
      </div>
      <div class="infos">
        <i class="fa-solid fa-location-dot"></i>
        <h6>Des Restaurants dans la Tunisie</h6>
        <h6>2641</h6>
      </div>
      <div class="infos">
